 ...
 * 3. startCopyRow1() 함수를 실행
 *
 * 참고: 환경 설정은 src/shared/config.js에서 관리됩니다
 */

// 환경 설정 (src/shared/config.js에서 가져옴)
const ROW1_SOURCE_SPREADSHEET_ID = getSourceSpreadsheet().id;
const ROW1_TARGET_SPREADSHEETS = getTargetSpreadsheets();

// 배치 처리 설정 (src/shared/config.js에서 가져옴)
const ROW1_MAX_EXECUTION_TIME = BATCH_CONFIG.MAX_EXECUTION_TIME;
const ROW1_SHEETS_PER_BATCH = BATCH_CONFIG.SHEETS_PER_BATCH;
