...
// 임시 파일에 스크립트 저장
const tempScriptPath = path.join(__dirname, '../src/temp-folder-creator.js');
fs.writeFileSync(tempScriptPath, scriptCode, 'utf8');

console.log('✅ 폴더 생성 스크립트 준비 완료');
console.log('');
console.log('📋 다음 단계를 수동으로 실행해주세요:');
console.log('');
console.log('1. 생성된 스프레드시트 열기:');
console.log('   https://docs.google.com/spreadsheets/d/1xmrR4KLWf2S7J4IQgHrJiIUEb4PCC9aUI7Mwbq29PcU');
console.log('');
console.log('2. 확장 프로그램 > Apps Script 클릭');
console.log('');
console.log('3. 코드 에디터에 다음 함수를 추가하고 실행:');
console.log('');
console.log(scriptCode);
console.log('');
console.log('4. 실행 후 로그에서 "은행거래내역Id" 복사');
console.log('');
console.log('5. 복사한 폴더 ID를 알려주세요!');
